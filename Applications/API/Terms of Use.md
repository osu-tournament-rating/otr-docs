...
The API must not be used to scrape information. Scraping data in any form is prohibited and will result in a permanent revocation of API access. Please see the [[Database Data|data]] page for more information on conveniently importing our dataset.
