...
- Fixed concurrent API requests bypassing rate limits. Requests made while the same account has another API request processing now receive HTTP `429`, including requests made with different API keys.
