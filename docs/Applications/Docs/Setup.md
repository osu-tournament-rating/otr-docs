The o!TR Docs serve to document anything and everything related to the o!TR project and are written using [Obsidian](https://obsidian.md/). This guide details the setup process.
